...
export default function ClientPortalLayout({
  ...
  return (
    <section className="bg-background text-primary">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100vh-100px)]">
        <div className={`relative w-full h-[40vh] sm:h-[45vh] md:h-[50vh] lg:h-full lg:aspect-auto overflow-hidden order-1 ${imageOrder}`}>
          <Image
            src="/images/portfoliopage/portfoliotwo.jpg"
            alt=""
            fill
        ...
        <div className={`order-2 ${formOrder} flex items-start justify-start px-4 sm:px-6 md:px-10 lg:px-12 xl:px-16 2xl:px-20 py-8 sm:py-10 md:py-14 lg:py-16 xl:py-20 2xl:py-24`}>
