...
export default function ForgotPassword() {
    ...
    const headingCls = "font-display font-thin uppercase tracking-[0.03em] leading-[100%] text-primary text-[40px] sm:text-[44px] md:text-[52px] lg:text-[64px] xl:text-[72px] 2xl:text-[80px]";
    ...
    return (
        <ClientPortalLayout imageSide="right">
            ...
            {step === "email" && (
                <form onSubmit={handleEmailSubmit}>
                    <h1 className={`${headingCls} lg:whitespace-nowrap`}>Forgot Password</h1>
                    ...
                    {emailError && (
                        ...
                        >
                            ...
                            />
                            <p className="font-sans font-medium tracking-[0.0125em] text-primary text-[15px] leading-[24px] sm:text-[16px] sm:leading-[26px] md:text-[17px] md:leading-[28px] lg:text-[16px] lg:leading-[26px] xl:text-[17px] xl:leading-[28px] 2xl:text-[18px] 2xl:leading-[30px]">
                                Sorry, no client profile associated with this email was found.
                            </p>
                        </div>
                    )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 lg:min-h-[calc(100vh-100px)]">
                ...
                <div className="flex items-center justify-center px-4 sm:px-6 md:px-10 lg:px-12 xl:px-16 2xl:px-20 py-12 sm:py-14 md:py-16 lg:py-16 xl:py-20 2xl:py-24">
                    <div className="w-full max-w-[520px] md:max-w-[640px] lg:max-w-[520px] xl:max-w-[600px] 2xl:max-w-[680px] flex flex-col items-center text-center">
                        <h1 className="font-display font-thin uppercase tracking-[0.03em] leading-[100%] text-primary text-[40px] sm:text-[44px] md:text-[52px] lg:text-[60px] xl:text-[68px] 2xl:text-[76px]">
                            Password Reset
                        </h1>
