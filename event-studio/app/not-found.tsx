...
export default function NotFound() {
  return (
    <section className="relative bg-background text-primary overflow-hidden h-screen max-[640px]:portrait:h-auto max-[640px]:portrait:min-h-screen max-[1024px]:landscape:h-auto max-[1024px]:landscape:min-h-screen">
      {/* Desktop unplug — fills viewport height, bleeds off top edge */}
<Image
  src="/icons/desktopunplug.svg"
  alt=""
  width={320}
  height={1400}
  className="hidden lg:block absolute -top-20 left-0 h-[calc(100vh+400px)] w-auto pointer-events-none"
/>

      {/* toprightcircle — bleeds off corner on mobile/landscape/iPad, tucked into upper-right on laptop+ */}
      <Image
      ...
      <Image
        ...
        width={70}
        height={70}
        className="absolute -bottom-6 -left-6 w-[70px] h-[70px] sm:-bottom-8 sm:-left-8 sm:w-[85px] sm:h-[85px] md:-bottom-10 md:-left-10 md:w-[100px] md:h-[100px] lg:bottom-8 lg:left-[15%] lg:w-[50px] lg:h-[50px] xl:bottom-8 xl:left-[20%] xl:w-[58px] xl:h-[58px] 2xl:bottom-28 2xl:w-[66px] 2xl:h-[66px] pointer-events-none"
      />

      {/* greyx #1 — above 404 (bigger on mobile/iPad, larger again on laptop+) */}
      <Image
        src="/icons/greyx.svg"
        alt=""
        width={66}
      ...
      {/* greyx #2 — bottom-right (decorative anchor, larger on laptop+) */}
      <Image
        src="/icons/greyx.svg"
        alt=""
        width={90}
      ...
      <Image
        ...
        width={900}
        height={1100}
        className="lg:hidden absolute -top-18 -left-28 w-[1200px] h-auto sm:-top-18 sm:-left-28 sm:w-[1200px] md:-top-96 md:-left-64 md:w-[1200px] pointer-events-none" 
      />

      {/* Main content */}
<div className="relative z-10 flex flex-col items-center justify-start text-center px-6 pt-[260px] pb-12 sm:pt-[320px] sm:pb-14 md:pt-[400px] md:pb-16 lg:min-h-[calc(100vh-100px)] lg:justify-center lg:pt-12 lg:pb-12 xl:pt-10 xl:pb-16 2xl:pt-20 2xl:pb-20">
